...
<body class="body">
      ...
      <div class="container" align="left" style="max-width:800px">
		<div class="progress">
			<div class="progress-bar" role="progressbar" aria-valuenow="{{completed_percentages['%s']}}" aria-valuemin="0" aria-valuemax="100" style="width: {{completed_percentages['%s']}}%;">
...
for each_topic in TOPIC_DICT:
    print(each_topic)
    os.makedirs(each_topic.replace(".","").replace(":",""))
    ...
    for eachele in TOPIC_DICT[each_topic]:
        try:
            ...
            print(filename)
            savePath = each_topic.replace(".","").replace(":","")+'/'+filename
...
#print(HTML_TEMPLATE.replace("%s","Basics"))
